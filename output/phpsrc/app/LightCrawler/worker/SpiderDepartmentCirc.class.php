...
class SpiderDepartmentCirc extends PHPCrawler
{
...
file_put_contents('spider_' . SpiderDepartmentCirc::MAGIC . '.pid', $pid);
...
$spider = new SpiderDepartmentCirc();

$spider->setFeed(SpiderDepartmentCirc::$SeedConf[0]);

for ($i=1;$i<count(SpiderDepartmentCirc::$SeedConf); $i++) {
    $spider->addStartingUrls(SpiderDepartmentCirc::$SeedConf[$i]);
}
