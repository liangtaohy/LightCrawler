 ...
 * 北京金融局
 * 通知通告
 * http://www.bjjrj.gov.cn/tztg/c44-list-1.html
 * User: liangtaohy@163.com
 * Date: 17/5/2
 * Time: PM12:26
 */
define("CRAWLER_NAME", "spider-bjjrj.gov");
require_once dirname(__FILE__) . "/../includes/lightcrawler.inc.php";

class SpiderBjjrjGov extends SpiderFrame
{
    ...
    protected $ContentHandlers = array(
        "#http://www\.bjjrj\.gov\.cn/tztg/c44-list-[0-9]+\.html# i" => "handleListPage",
        "#http://www\.bjjrj\.gov\.cn/tztg/c44-a[0-9]+\.html# i"  => "handleDetailPage",
        "#/[0-9a-zA-Z_]+\.(doc|pdf|txt|xls)# i" => "handleAttachment",
    );

    /**
     * SpiderBjjrjGov constructor.
     */
